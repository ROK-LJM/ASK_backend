...
public class BoardServiceImpl implements BoardService{
    ...
    // 사원관리 - 사원정보 중복 처리
    @Override
    public int getEmpCode(EmpDTO empDTO) throws Exception{
        return boardMapper.getEmpCode(empDTO);
    }

    // 회사 설정 - 회사 중복 체크
    @Override
    public int checkCompany(CompanyDTO companyDTO) throws Exception{
        return boardMapper.checkCompany(companyDTO);
    }
    ...
    // 부서관리 - 부서정보 수정(update)
    @Override
    public int updateDep(DepDTO depDTO) throws Exception{
        return boardMapper.updateDep(depDTO);
    }

    // 부서관리 - depCode 리스트 가져오기
    @Override
    public int getDepCode(DepDTO depDTO) throws Exception{
        return boardMapper.getDepCode(depDTO);
    }

    // 부서관리 - 부서정보 수정 모달(modal)
    @Override
    public ArrayList<DepDTO> updateDepModal(DepDTO depDTO) throws Exception{
        return boardMapper.updateDepModal(depDTO);
    }
    ...
    // 수당관리 - 수당 계산식 update
    @Override
    public int updateCalc(Emp_payDTO emp_payDTO) throws Exception{
        return boardMapper.updateCalc(emp_payDTO);
    }


    // 수당관리 - 수당항목 삭제(delete)
    @Override
    public int deleteEmpPay(Emp_payDTO emp_payDTO) throws Exception{
        return boardMapper.deleteEmpPay(emp_payDTO);
    }
    ...
    // 세금관리 - 세금코드 중복확인
    @Override
    public int checkCreateTax(TaxDTO taxDTO) throws Exception{
        return boardMapper.checkCreateTax(taxDTO);
    }
    ...
    // 세금관리 - 세금 카테고리 목록들 불러오기(read)
    @Override
    public ArrayList<TaxCategoryDTO> readTaxCategory(TaxCategoryDTO taxCategoryDTO) throws Exception{
        return boardMapper.readTaxCategory(taxCategoryDTO);
    }

    // 세금관리 - 선택한 세금항목 값 주기(read)
    @Override
    public ArrayList<TaxCategoryDTO> getTaxCategory(TaxCategoryDTO taxCategoryDTO) throws Exception{
        return boardMapper.getTaxCategory(taxCategoryDTO);
    }
    ...
    // 세금관리 - 세금코드 중복값 확인
    @Override
    public int getTaxCode(TaxDTO taxDTO) throws Exception{
        return boardMapper.getTaxCode(taxDTO);
    }
    ...
    // 세금관리 - 세금정보 삭제(delete)
    @Override
    public int deleteTax(TaxDTO taxDTO) throws Exception{
        return boardMapper.deleteTax(taxDTO);
    }

    // 수당관리 - 비과세 목록 가져오기(read)
    @Override
    public ArrayList<TaxFreeDTO> readTaxFree(TaxFreeDTO taxFreeDTO) throws Exception{
        return boardMapper.readTaxFree(taxFreeDTO);
    }

    // 수당관리 - payCode 수당코드 중복값 확인
    @Override
    public int getPayCode(Emp_payDTO emp_payDTO) throws Exception{
        return boardMapper.getPayCode(emp_payDTO);
    }
    ...
    //경비관리 update 요청날짜 변경
    @Override
    public int expenseUpdateRequest(Expense_infoDTO expense_infoDTO) throws Exception {
        return boardMapper.expenseUpdateRequest(expense_infoDTO);
    }
    //경비관리 update 승인날짜 변경
    @Override
    public int expenseUpdateApproval(Expense_infoDTO expense_infoDTO) throws Exception {
        return boardMapper.expenseUpdateApproval(expense_infoDTO);
    }
    //경비관리 delete
    @Override
    ...
    @Override
    public int getCountReceipt(Expense_infoDTO expenseInfoDTO) throws Exception{
        return boardMapper.getCountReceipt(expenseInfoDTO);
    }
    ...
    // 매입
    @Override
    public Integer getIncomeData(IncomeDTO incomeDTO) throws Exception{
        return boardMapper.getIncomeData(incomeDTO);
    }

    // 매출
    @Override
    public Integer getOutcomeData(IncomeDTO incomeDTO) throws Exception{
        return boardMapper.getOutcomeData(incomeDTO);
    }
    //------------------------------ 위도, 경도 찾기 --------------------------------------
    //주소 -> 위경도 변환
    //지오코딩 카카오 주소 API
    ...
    // 모바일 로그인 - 계정 존재 여부 확인
    @Override
    public int checkMbLogin(MbUserDTO mbUserDTO) throws Exception{
        return boardMapper.checkMbLogin(mbUserDTO);
    }

    // 모바일 로그인 - 계정 정보 불러오기
    @Override
    public MbUserDTO getMbData(MbUserDTO mbUserDTO) throws Exception{
        return boardMapper.getMbData(mbUserDTO);
    }

    // 모바일 로그인 - 최초 로그인(비밀번호 변경)
    @Override
    public int mbFirstUpdate(MbUserDTO mbUserDTO) throws Exception{
        return boardMapper.mbFirstUpdate(mbUserDTO);
    }

    //------------------------------------------ < 모바일 메인페이지 > ----------------------------------------------------
    // 모바일 메인페이지 - 출퇴근 현황 표시
    @Override
    public InOut_infoDTO getInOutData(InOut_infoDTO inOut_infoDTO) throws Exception{
        return boardMapper.getInOutData(inOut_infoDTO);
    }
}
